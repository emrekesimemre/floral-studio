      ...
      >
        <div className="max-w-7xl mx-auto px-6 w-full flex items-center justify-between">
          <Link
            ...
            className={`text-xl md:text-2xl font-thin tracking-[0.3em] transition-all duration-300 ${
              isOpen
                ? "text-floral-text mix-blend-normal"
        ...
        {isOpen && (
          ...
          >
            <Link
              href="#koleksiyon"
              onClick={() => setIsOpen(false)}
              className="hover:text-floral-primary transition-colors tracking-tighter"
            >
              Koleksiyon
            </Link>
            <Link
